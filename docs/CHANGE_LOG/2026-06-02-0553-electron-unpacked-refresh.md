# 2026-06-02 05:53 - Electron unpacked 产物刷新

## 变更

- 重新执行 `npm.cmd run electron:build`，把媒体键默认快捷键修正打进 Windows unpacked 产物。
...
- `release-electron\win-unpacked\Hills Lite.exe` 文件时间：2026-06-02 05:52:59。
- `release-electron\win-unpacked\resources\electron_mpv_host.exe` 文件时间：2026-06-02 05:52:57。
