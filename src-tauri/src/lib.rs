...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::player::play_standalone,
            commands::player::stop_standalone,
            commands::player::standalone_control,
            ...
            commands::player::embed_pointer_probe,
            ...
            commands::player::ensure_mpv_conf,
            commands::player::open_player_log_dir,
            ...
            commands::player::set_anime4k_mode,
